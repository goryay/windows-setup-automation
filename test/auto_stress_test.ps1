...
$argumentString = "-NoProfile -ExecutionPolicy Bypass -File `"$testScript`" -UsbRoot `"$usbRoot`" $($testArgs -join ' ')"
$process = Start-Process -FilePath $psExe -ArgumentList $argumentString -Wait -NoNewWindow -PassThru
